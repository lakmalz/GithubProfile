...
public final class GitProfileQuery: GraphQLQuery {
  ...
  public let operationDefinition: String =
    """
    query GitProfile($gitName: String!) {
      user(login: $gitName) {
        __typename
        avatarUrl
        name
  ...
  public init(gitName: String) {
    self.gitName = gitName
  }

  public var variables: GraphQLMap? {
    return ["gitName": gitName]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("user", arguments: ["login": GraphQLVariable("gitName")], type: .object(User.selections)),
      ]
    }
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          ...
          GraphQLField("topRepositories", arguments: ["first": 10, "orderBy": ["direction": "ASC", "field": "UPDATED_AT"]], type: .nonNull(.object(TopRepository.selections))),
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public struct Fragments {
            ...
            public var repositoryFragment: RepositoryFragment? {
              get {
                if !RepositoryFragment.possibleTypes.contains(resultMap["__typename"]! as! String) { return nil }
...
public struct RepositoryFragment: GraphQLFragment {
  ...
  public init(name: String, description: String? = nil, stargazerCount: Int, owner: Owner, primaryLanguage: PrimaryLanguage? = nil) {
    self.init(unsafeResultMap: ["__typename": "Repository", "name": name, "description": description, "stargazerCount": stargazerCount, "owner": owner.resultMap, "primaryLanguage": primaryLanguage.flatMap { (value: PrimaryLanguage) -> ResultMap in value.resultMap }])
  }
  ...
  public struct Owner: GraphQLSelectionSet {
    ...
    public static func makeOrganization(name: String? = nil, avatarUrl: String) -> Owner {
      return Owner(unsafeResultMap: ["__typename": "Organization", "name": name, "avatarUrl": avatarUrl])
    }
    ...
    public struct AsOrganization: GraphQLSelectionSet {
      ...
      public init(name: String? = nil, avatarUrl: String) {
        self.init(unsafeResultMap: ["__typename": "Organization", "name": name, "avatarUrl": avatarUrl])
      }
